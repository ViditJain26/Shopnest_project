  ...
  return (
    <div style={textualStyle}>
      ...
      <p style={{ marginBottom: "15px" }}>
        ...
        in the same condition that it was received, and maintained within its
        original factory packaging. Receipts or proof of purchase mappings are
        strictly required.
      </p>
      ...
      <p style={{ marginBottom: "15px" }}>
        ...
        payment method within 5-7 business working days.
      </p>
